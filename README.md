...
[![Build Status](https://img.shields.io/badge/build-passing-brightgreen)](https://Chhinghor-portfolio.netlify.app/)
...
💻 Live [demo](https://Chhinghor-portfolio.netlify.app/)
...
```shell
$ git clone https://github.com/Chhinghor/Chhinghor-portfolio.git
```
...
All the information on the template is present in `info.js` that can be found in the root director, or [here](https://github.com/Chhinghor/Chhinghor-portfolio). This consists of various parameters that handle the information on the website. To add your own information, just edit the contents of this file, and the changes should be noticed. All the pictures need ot be present in `/src/assets` (or you can configure the path in the info.js file).
...
### Option 1
  - Clone this repo to your local machine using `https://github.com/Chhinghor/Chhinghor-portfolio`
- Code code code!
- Create a new pull request using <a href="https://github.com/Chhinghor/Chhinghor-portfolio" target="_blank">`https://github.com/Chhinghor/Chhinghor-portfolio`</a>
...
- Website at <a href="https://Chhinghor-portfolio.netlify.app/" target="_blank">`https://Chhinghor-portfolio.netlify.app/`</a>
- LinkedIn at <a href="https://www.linkedin.com/in/Chhinghor//" target="_blank">`Chhinghor Bogdan`</a>
...
- Copyright 2021 © <a href="https://github.com/Chhinghor/Chhinghor-portfolio/tree/main" target="_blank">Chhinghor</a>
